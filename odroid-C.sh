...
umount -l $bootp
umount -l $rootp
echo "Joseph Make sure that you unmount $bootp $rootp and $loopdevice"
...
#rm -rf ${basedir}/kernel ${basedir}/bootp ${basedir}/root ${basedir}/mangoes-$architecture ${basedir}/u-boot
...
addFooter;
## This is also not working corectly
## tidyUp;
